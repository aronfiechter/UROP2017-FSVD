...
\begin{document}
    ...
    The intersections of a line and a parabola can be found by solving the equation of the line for \(y\), then inserting it into the equation of the parabola to get a quadratic equation in \(x\).\par
    The resulting \(x\)(s) of the equation can be input in the line equation to get the corresponding value(s) of \(y\), each indicating a point of intersection.\par
